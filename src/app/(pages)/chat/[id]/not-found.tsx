  ...
  return (
    <>
      <div className=" h-full w-full bg-black rounded-lg ">
        <div className="bg-gray-100 dark:bg-slate-800 h-full justify-center">
          <center className="pt-24 m-auto">
            ...
            <div className=" tracking-widest mt-4">
              <span className="text-gray-500 dark:text-slate-200 text-6xl block">
                <span>4 0 4</span>
              </span>
              <span className="text-gray-500 dark:text-slate-200 text-xl">
                Sorry, We couldn&apos;t find the chat you are looking for!
              </span>
            </div>
          </center>
          <center className="mt-6">
            <button
              onClick={()=>router.back()}
              className="text-gray-500 dark:text-slate-200 font-mono text-xl bg-gray-20 dark:bg-slate-700 p-3 rounded-md hover:shadow-md"
            >
              Go back{" "}
            </button>
          </center>
